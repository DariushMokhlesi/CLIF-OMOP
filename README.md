...
# Getting Started
Before running any of the scripts, please specify the local file paths for the 'clif_parquet_dir' and 'omop_parquet_dir' in the config.json file.

# Authors
Dariush Mokhlesi (GitHub: DariushMokhlesi) and Kian Mokhlesi (GitHub: KianMokhlesi)

# Note
This repository converts several Omop tables (person, visit_occurence, measurement, and drug_exposure) to their corresponding CLIF tables (patient, hospitalization, vitals, medication_admin_continuous) and vice versa. 
